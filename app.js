...
function currentDesign() {
  return { joints, pipes, panels, bridges, slides, notes, rulers, groups, special, hidden: [...hidden], activeLength, nextId };
}
...
function clearDesign() {
  joints = []; pipes = []; panels = []; bridges = []; slides = []; notes = []; groups = []; special = { roof: 0, glasses: 0 }; hidden = new Set(); nextId = 1; selection = []; activeJoint = null;
  handleGroup.visible = false; cubeGroup.visible = false;
